        ...
        <section className='relative py-28 sm:py-36 px-8 sm:px-12 md:px-20 lg:px-28 overflow-hidden'>
            ...
            <div className='max-w-7xl mx-auto relative z-10'>
                ...
                >
                    ...
                    <h2 className='font-2 text-[12vw] sm:text-[7vw] lg:text-[4.5vw] text-black leading-[0.9] tracking-[-0.02em]'>
                        What is HNTRS?
                    </h2>
                </div>
                ...
                <div className='grid lg:grid-cols-12 gap-8 lg:gap-12'>
                    ...
                    >
                        <div className='bg-white/60 backdrop-blur-sm border border-black/[0.06] p-8 sm:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)]'>
                            <h3 className='font-7 italic text-[#DE5127] text-2xl sm:text-3xl mb-8'>
                                The Future of Sports Memorabilia
                            </h3>
                            <div className='space-y-6 font-gs text-black/60 leading-relaxed'>
                                <p>
                            ...
                            <div className='grid grid-cols-2 sm:grid-cols-3 gap-4 mt-10 pt-10 border-t border-black/[0.06]'>
                                {[
                                    ...
                                    <div key={item.label} className='text-center'>
                                        <p className='font-2 text-2xl text-[#DE5127] mb-1'>{item.value}</p>
                    ...
                    >
                        <div className='grid grid-cols-2 gap-4'>
                            {[
                                ...
                                <div
                                    key={stat.label}
                                    className={`p-5 sm:p-6 bg-white/80 backdrop-blur-sm border border-black/[0.06] hover:border-[#DE5127]/30 transition-all duration-300 overflow-hidden hover:-translate-y-1 hover:scale-[1.02] ${i % 2 === 1 ? 'mt-4' : ''}`}
                                >
                                    <p className='font-2 text-3xl sm:text-4xl text-black mb-2 truncate'>
                                        {stat.value === '∞' ? <span className='text-[#DE5127]'>∞</span> : stat.value}
                                    </p>
                                    <p className='font-gs text-[11px] uppercase tracking-[0.15em] text-black font-medium mb-1'>{stat.label}</p>
                                    <p className='font-gs text-[10px] text-black/40'>{stat.sub}</p>
                                </div>
                            ))}
                        </div>
