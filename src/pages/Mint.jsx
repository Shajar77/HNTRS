          ...
          <div className="text-center max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}>
              ...
              <div className="relative mb-6 sm:mb-8 overflow-hidden">
                <h1 className='font-2 text-[clamp(1.75rem,10vw,7rem)] sm:text-[clamp(3rem,12vw,6rem)] md:text-[clamp(3.5rem,10vw,5rem)] lg:text-[clamp(3rem,8vw,4rem)] text-black leading-[0.85] tracking-[-0.02em] break-words'>CREATE</h1>
                <motion.div 
                  initial={{ scale: 0 }} 
                  animate={{ scale: 1 }} 
                  ...
                  <span className='font-2 text-white text-[7px] sm:text-[8px] md:text-[10px]'>+</span>
                </motion.div>
              </div>
              
              {/* Subtitle */}
              <p className="font-7 italic text-[#DE5127] text-lg sm:text-xl md:text-2xl lg:text-3xl tracking-tight mb-8 sm:mb-12">on the blockchain</p>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }} className="mb-20 sm:mb-28">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div className="overflow-hidden">
              <h1 className='font-2 text-[clamp(1.75rem,10vw,6rem)] sm:text-[clamp(2.5rem,10vw,5rem)] md:text-[clamp(2.5rem,7vw,4rem)] lg:text-[clamp(2rem,5vw,3.5rem)] text-black leading-[0.9] tracking-[-0.01em] break-words'>Mint NFT</h1>
